                            ...
                            <div key={index}>
                                <motion.div variants={topVariants} initial="initial"
                                    ...
                                    <div className={`content px-5 lg:px-7 xl:px-12 py-7 lg:py-10 ${carddata.css}`}>
                                        ...
                                        <p className='xl:w-10/12 font-light text-[#646474] text-[15px] lg:text-[18px] xl:text-[20px] leading-[22px] md:leading-[25px] lg:leading-tight'>{carddata.cardDesc}</p>
                                    </div>
                                    <div className="image">
                        ...
                        <div className="col-span-12">
                            <motion.div variants={textVariants}
                                ...
                                <motion.h3 variants={textVariants}
                                    initial="initial"
                                    whileInView="animate" className='md:mb-5 font-bold text-[18px] text-center text-white lg:text-[25px] lg:text-left xl:text-[30px] leading-normal'>
                                    {ctaTitle}
                                </motion.h3>
