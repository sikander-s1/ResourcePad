...
import CardShade from "media/assets/images/cardbgShade.png"
import Icon1 from "media/assets/images/icons/linkedin.png"
import Icon2 from "media/assets/images/icons/twitter.png"
import CardParticle from "media/assets/images/cardParticle.png"
                ...
                <div className="grid grid-cols-12">
                    <div className="col-span-12 xl:col-span-8 xxl:col-span-7">
                        <motion.div variants={textVariants}
                            ...
                            <motion.p variants={textVariants} className='text-[#646474] text-[14px] md:text-[16px] lg:text-[19px] leading-[22px] md:leading-[26px] lg:leading-[29px] mb-6 lg:mb-8 text-center lg:text-left'>{desc}</motion.p>
                        </motion.div>
                    </div>
                </div>
            </div>
