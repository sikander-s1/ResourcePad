            ...
            <div className="container">
                <div className="grid grid-cols-12">
                    <div className="col-span-12">
                        ...
                        <p className='sm:mb-5 lg:mb-10 text-[#646474] text-[14px] text-center md:text-[16px] lg:text-[20px] leading-[26px] lg:leading-[30px]'>When she reached the first hills of the Italic Mountains had a last view back on the skyline.</p>
                    </div>
                </div>
                <div className="relative z-0 py-12 rounded-[20px] px-0 sm:px-[60px] xl:px-[120px] sm:h-[552px] sm:mt-[15px] lg:mt-[80px]">
                    ...
                    <div className="grid grid-cols-12 relative gap-y-6">
                        ...
                        <div className="col-span-12 lg:col-span-4">
                            <div className="relative h-full px-4 xxl:px-6 pt-[50px] lg:pt-[60px] text-center">
                                <Image src={Number1} alt='Number' className='absolute top-0 lg:top-[-15px] left-0 right-0 mx-auto' />
                                <h3 className='text-white text-[20px] xl:text-[25px] leading-[25px] xl:leading-[30px] font-bold mb-4'>
                                    Tailored Solutions
                                </h3>
                                <p className='text-[16px] xl:text-[18px] leading-[22px] xl:leading-[25px] text-white font-light opacity-80 xl:w-10/12 mx-auto'>We offer customized solutions tailored to your nonprofit’s unique needs, goals, and vision.</p>
                            </div>
                        </div>
                        <div className="col-span-12 lg:col-span-4">
                            <div className="relative h-full px-4 xxl:px-6 pt-[50px] lg:pt-[60px] text-center lg:mt-[4px] xl:mt-[15px] xxl:mt-[30px]">
                                ...
                                <p className='text-[16px] xl:text-[18px] leading-[22px] xl:leading-[25px] text-white font-light opacity-80 xl:w-10/12 mx-auto'>With deep nonprofit expertise, we create solutions that tackle unique challenges for greater impact and efficiency.</p>
                            </div>
                        </div>
                        <div className="col-span-12 lg:col-span-4">
                            <div className="relative h-full px-4 xxl:px-6 pt-[50px] lg:pt-[60px] text-center">
                                ...
                                <p className='text-[16px] xl:text-[18px] leading-[22px] xl:leading-[25px] text-white font-light opacity-80 xl:w-11/12 mx-auto lg:px-2'>We provide affordable, value-driven packages that maximize your investment without sacrificing quality.</p>
                            </div>
                        </div>
                    </div>
                </div>
